  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Opération de virement</li>
      </ol>
      <div class="row">
        <div class="col-12">
      ...
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" placeholder="Entrer le montant">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Compte a débiter</label>
            <select class="form-control" id="exampleInputPassword1" type="password" placeholder="Password">
